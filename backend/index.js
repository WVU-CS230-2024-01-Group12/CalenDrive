...
app.post('/events', (req, res) => {
    const values = [req.body.name, req.body.desc, req.body.address, req.body.lat, req.body.lon, req.body.start, req.body.end];
    const q = "INSERT INTO events (`name`, `desc`, `address`, `lat`, `lon`, `start`, `end`) VALUES (?)";
...
app.put('/events/:id', (req, res) => {
    ...
    const values = [req.body.name, req.body.desc, req.body.address, req.body.lat, req.body.lon, req.body.start, req.body.end];
    const q = "UPDATE events SET `name` =?, `desc` =?, `address` =?, `lat` =?, `lon` =?, `start` =?, `end` =? WHERE id=?"
