...
export function UpdateEvent({ onClick, ev }) {
  ...
  /**
   * Handles submitting updated event info to the server
   * @param {Event} e Event to update information for
   * @returns err if submitting changes to server fails
   */
